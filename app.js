...
addButton.addEventListener("click", () => {
  ...
  opt13.setAttribute("value", "D-");
  let textNode13 = document.createTextNode("D-");
  opt13.appendChild(textNode13);
  var opt14 = document.createElement("option");
  opt14.setAttribute("value", "F");
  let textNode14 = document.createTextNode("F");
  opt14.appendChild(textNode14);
